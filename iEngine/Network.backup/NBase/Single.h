...
#ifndef BOOSTASIONETWORK_NBASE_SINGLE_H_
#define BOOSTASIONETWORK_NBASE_SINGLE_H_

namespace BoostAsioNetwork { namespace NBase {
...
#endif /* BOOSTASIONETWORK_NBASE_SINGLE_H_ */
